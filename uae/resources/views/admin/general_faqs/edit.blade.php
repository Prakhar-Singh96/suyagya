...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-0">Edit FAQ</h4>
        <a href="{{ route('admin.general-faqs.index') }}" class="btn btn-secondary">Back</a>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.general-faqs.update', $faq->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="answer" id="editor" class="form-control" rows="4">{{ $faq->answer }}</textarea>
                    </div>
                </div>
